...
@section('sub_title')
<h2>Cadastrar Cliente<small></small></h2>
@endsection

<form method="POST" action="{{ route('app.clientes.storeCliente') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    @csrf
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input type="text" id="cpf" name="cpf" value="{{ old('cpf') }}" maxlenght="14" class="form-control" data-mask-for-cpf-cnpj required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input type="text" id="telefone" name="telefone" value="{{ old('telefone') }}" onkeyup="mascara(this, mtel);" maxlength="15" class="form-control" required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input type="email" id="email" name="email" value="{{ old('email') }}" maxlenght="200" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="mail@exemplo.com, mail@exemplo.com.br" class="form-control" required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
        <input type="text" class="form-control" name="cep" id="cep" value="{{ old('cep') }}" maxlength="10" onblur="pesquisacep(this.value);" required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
        <input type="text" name="endereco" id="endereco" value="{{ old('endereco') }}" maxlength="200" class="form-control" required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
        <input type="text" name="complemento" id="complemento" value="{{ old('complemento') }}" maxlength="200" class="form-control">
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
        <input type="text" name="bairro" id="bairro" value="{{ old('bairro') }}" maxlength="100" class="form-control" required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
        <input type="text" class="form-control" name="cidade" id="cidade" value="{{ old('cidade') }}" maxlength="100" required>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
        <input type="text" class="form-control" name="estado" id="estado" value="{{ old('estado') }}" maxlength="2" required>
        </div>
    </div>
