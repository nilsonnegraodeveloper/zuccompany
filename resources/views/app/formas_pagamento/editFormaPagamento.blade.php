...
@section('sub_title')
<h2>Editar Forma de Pagamento<small></small></h2>
@endsection

<form method="POST" action="/app/formasPagamento/{{ $formaPagamento->id }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    @csrf
    @method('PUT')
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input type="text" id="nome" name="nome" maxlenght="100" value="{{ $formaPagamento->nome }}" class="form-control" required>
        </div>
    </div>
